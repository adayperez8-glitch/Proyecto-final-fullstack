...
import { sessionCongratsSchema } from './maintenance.schema.js'
...
router.post('/session-congrats', requireApiKey, validate(sessionCongratsSchema), asyncHandler(ctrl.sessionCongrats))
